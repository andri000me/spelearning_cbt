	<div  class="page">
		...
		<hr>
		<br>
		<p>Pada hari ini <?= $tgl; ?>, di <?= ucwords($GLOBALS['sp']['XSekolah']); ?> telah diselenggarakan <?= $ujian->XNamaUjian; ?> Berbasis Komputer untuk matapelajaran <?= $ujian->XNamaMapel; ?> <?= $pukul; ?></p>
		  <br>
		  <table border="0" width="85%" style="margin-left:50px">
		  <tr height="30">
		  <td height="30" width="5%">1.</td>
		  <td height="30">Sekolah/Madrasah</td>
		  <td height="30" width="60%" style="border-bottom:thin solid #000000"><?= $GLOBALS['sp']['XSekolah']?></td>  
		  </tr>
<!-- 		  <tr height="30">
