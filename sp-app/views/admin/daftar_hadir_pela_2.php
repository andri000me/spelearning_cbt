					...
					<td valign="top">
						<b>
							<center>
							    ...
							    <br><font>PEMBELAJARAN ONLINE</font>
...
<!-- 			</table>
			<table width="100%"> -->
			  <tr>
				  <td width="15%" valign="top">Waktu</td>
		  	 ...
		  	 <table border="1" width="100%">
		  	 	...
		  	 	<tbody>
					...
					foreach ($siswa->result_array() as $f) {
						...
						$this->db->where("XNomerUjian",$f['XNomerUjian']);
						$this->db->where("XIdPelajaran",$info['XIdPelajaran']);
						if ($this->db->get("cbt_siswa_pelajaran")->num_rows() == 0) {
							echo "<td align='center'></td></tr>";
						} else {
							echo "<td align='center'>Mengikuti</td></tr>";
						}
						// echo "<td align='center'>&nbsp;</td></tr>";
						  $no++;
					}
