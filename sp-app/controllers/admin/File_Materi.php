...
class File_Materi extends CI_Controller {
	var $judul;
	function __construct(){
		parent::__construct();
		$this->m_config->cek_sesi();
		$this->judul="File_Materi";
	}
	...
	public function kosongkan($Urut=0)
	{
		...
		$this->m_config->pindah("admin/File_Materi/index/",1,"Sukses Menghapus File");
	}
	...
	{	
		...
		$file=$folder."/".$file;
		if (unlink($file)) {
			$this->m_config->pindah("admin/File_Materi/index/#".$jenis,1,"Sukses Menghapus File");
		} else {
			$this->m_config->pindah("admin/File_Materi/index/#".$jenis,0,"Gagal menghapus file");
		}
	}
	...
	public function proupload($value='')
	{
        ...
        for($i = 0; $i < $filesCount; $i++){
		   ...
		   $uploaddir = "gambar"; //a directory inside
         	...
         	$config['upload_path']          = './asset/uploads/file_materi/'.$uploaddir;
        ...
        // echo $data['pesan'];
        $this->m_config->pindah("admin/File_Materi/upload/",2,$data['pesan']);
	}
